...
```
# per method (example values): cov = covered / executable lines
create:  R=2 LOC=18 D=1.8 CC=3   cov=5/10
place:   R=5 LOC=60 D=4.2 CC=14  cov=8/40
reserve: R=3 LOC=40 D=2.1 CC=9   cov=0/25
quote:   R=1 LOC=25 D=0.6 CC=5   cov=12/15   # quote is a shared component if used by 2+ APIs
...
CC_agg  = 3+14+9+5 = 31
cov(line-weighted) = (5+8+0+12)/(10+40+25+15) = 25/90 ≈ 0.278
   # a mean of ratios would be (0.50+0.20+0.00+0.80)/4 = 0.375 → masks the big untested method
...
cov'(line-weighted) = (5+8+0)/(10+40+25) = 13/75 ≈ 0.173 → M' = 1/(0.273) ≈ 3.66
Composite' = 26 × 8.1 × 3.66 ≈ 771   # excluding quote's high coverage makes the risk stand out more
```
